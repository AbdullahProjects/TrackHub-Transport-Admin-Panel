...
const AppBar = ({ onMenuClick }) => {
  ...
  return (
    <div className="h-16 bg-white shadow-sm fixed top-0 left-0 lg:left-[155px] w-full lg:w-[90%] z-40 flex items-center justify-between px-4 md:px-8 py-4">
      ...
      <div className="flex items-center gap-2">
        <div className="flex items-center justify-center w-8 h-8 rounded-full bg-primary text-white font-semibold">
          {adminData?.email.charAt(0).toUpperCase() || "Admin"}
        </div>
